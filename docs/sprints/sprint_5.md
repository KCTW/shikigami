...
**「完成 v0.3.0 Tech Debt Registry，並同步建立 ADR-002 解鎖測試框架擴展路徑」**

US-10 為 v0.3.0「知識沉澱」主題的第二個交付，建立技術債務追蹤基礎。ADR-002 作為測試框架技術選型決策，是 US-T01 執行的硬性前置條件，須優先完成。US-10 與 ADR-002 可並行推進，US-T01 待 ADR-002 完成後啟動。

對應 ROADMAP：v0.3.0「知識沉澱」推進 + 測試框架擴展解鎖。
...
- 合計：~1.0 Sprint（預估 4 points，歷史 Velocity 4-5，保留緩衝）

**Points 換算**（T-shirt Sizing）：ADR-002 = 1pt（S）、US-10 = 2pt（M）、US-T01 = 1pt（S）= 合計 **4 points**
